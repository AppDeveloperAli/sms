            ...
            body: json.encode(
              {
                ...
                'template_params': {
                  'email': emailController.text,
                  'role': "Student",
                  'username': studentController.text,
            ...
            children: [
              TextFormField(
                decoration: const InputDecoration(
                  label: Text("Student Name ( Username )"),
